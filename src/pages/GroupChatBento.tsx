        ...
        <div className="flex items-center gap-2">
          ...
          <div
            className={`max-w-[85%] sm:max-w-[75%] md:max-w-[65%] rounded-2xl px-4 py-2.5 text-[15px] leading-relaxed relative ${
              isMe
                ? "bg-white shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 text-gray-900 rounded-tr-sm shadow-sm"
            ...
            <div className="flex items-center gap-2 md:gap-3 max-w-4xl mx-auto w-full relative">
              ...
              <div className="flex-1 relative">
                ...
                <button
                  ...
                  className="absolute right-1.5 top-1/2 -translate-y-1/2 p-2 bg-white shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 text-gray-900 rounded-full hover:bg-gray-800 disabled:opacity-40 disabled:hover:bg-white text-gray-900 border border-gray-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] transition-all shadow-sm"
                >
                ...
                <div>
                  ...
                  <div className="flex items-center justify-between gap-4">
                    ...
                    <button
                      ...
                      className={`relative inline-flex h-6 w-11 shrink-0 cursor-pointer items-center rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-[#111827] focus:ring-offset-2 ${isEphemeral ? "bg-white text-gray-900 border border-gray-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)]" : "bg-gray-200"}`}
                    >
            ...
            <div className="bg-white rounded-2xl shadow-xl max-w-md w-full max-h-[90vh] overflow-y-auto custom-scrollbar border border-gray-100 animate-in zoom-in-95 duration-200">
              ...
              <div className="p-5 border-t border-gray-100 bg-gray-50/50">
                <button
                  ...
                  className="w-full px-4 py-3 text-sm font-bold text-white bg-white text-gray-900 border border-gray-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:bg-gray-900 rounded-xl transition-all shadow-sm active:scale-[0.98]"
                >
                  {isSharingLocation
            ...
            <div className="bg-white rounded-2xl shadow-xl max-w-md w-full p-6 border border-gray-100 animate-in zoom-in-95 duration-200">
              ...
              <div className="flex justify-end gap-3">
                ...
                <button
                  ...
                  className="px-5 py-2.5 text-sm font-bold text-white bg-white text-gray-900 border border-gray-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:bg-gray-900 rounded-xl transition-all shadow-sm hover:shadow-md"
                >
                ...
                {[
                  {
                    ...
                    color: "bg-white shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 text-gray-900 hover:bg-gray-900",
                  },
                  {
