          ...
          <div className="space-y-4">
            <Card className="p-4 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
              ...
              <div className="flex gap-2">
                <button className="text-[18px]  tracking-wider bg-gray-800 border border-gray-700 hover:bg-gray-200 text-gray-200 px-3 py-1.5 rounded font-bold transition-colors shadow-sm border border-gray-700">{t(`Εξέταση`, `Review`)}</button>
