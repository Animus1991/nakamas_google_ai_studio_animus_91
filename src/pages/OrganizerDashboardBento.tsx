    ...
    <div className="mx-auto max-w-full space-y-8 pb-12">
      <div className="flex justify-between items-end">
        <div>
          ...
          <p className="mt-1 text-[13.551608211075px] text-gray-900 font-medium">{t(`Διαχείριση εκδηλώσεων & ομάδων`, `Manage events & groups`)}</p>
        </div>
        <Button className="bg-white shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 text-gray-900 flex items-center gap-2 text-[14.2457535px] font-bold px-4 hover:bg-black" onClick={() => navigate('/create')}>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        ...
        <Card className="p-4 border-t-4 border-t-amber-500">
          ...
          <p className="text-[11.2px] text-gray-900 font-medium">23 {t(`αξιολογήσεις`, `reviews`)}</p>
        </Card>
        <Card className="p-4 border-t-4 border-t-purple-500">
          ...
          <p className="text-[11.2px] text-gray-900 font-medium">{t(`αυτόν τον μήνα`, `this month`)}</p>
        </Card>
      </div>
      ...
      <Card className="p-4">
        ...
        <p className="text-[11.2px] text-gray-900 font-medium mt-1">{t(`18 από 25 θέσεις καλύφθηκαν συνολικά`, `18 of 25 spots filled overall`)}</p>
      </Card>
      ...
      <Card className="p-4">
        <div className="flex items-center justify-between mb-3">
          ...
          <span className="text-[11.2px] font-medium text-gray-900">{t(`Τελ. 30 μέρες`, `Last 30 days`)}</span>
        </div>
        ...
        <div className="flex items-center gap-2 mt-3 text-[11.2px] text-gray-900 font-medium">
      ...
      <div>
        <h3 className="text-[12.5px] font-bold text-gray-900 tracking-wide mb-2">{t(`Γρήγορη Δημιουργία`, `Quick Create`)}</h3>
        <div className="flex gap-2 overflow-x-auto pb-1 noscrollbar">
          {[
            ...
            <button key={tpl.label} onClick={() => navigate('/create')} className="shrink-0 flex items-center gap-1.5 px-3 py-1.5 rounded-full border border-gray-200 bg-white hover:bg-cyan-50 hover:border-cyan-200 transition-colors text-[12.5px] font-bold text-gray-900">
      ...
      <div className="space-y-6">
          ...
          <div className="p-4 flex flex-col md:flex-row items-start md:items-center justify-between gap-4 border-b border-gray-100 bg-gray-50/50">
            <div className="flex flex-col">
               <div className="flex items-center gap-2 mb-1">
                 ...
                 <span className="text-[12.5px] text-gray-900 font-bold tracking-wide">{t(`Σε 2 μέρες`, `In 2 days`)}</span>
               </div>
               <h3 className="text-[18px] font-bold text-[#111827]">{t(`Stand-up Comedy Night`, `Stand-up Comedy Night`)}</h3>
            </div>
            <div className="flex gap-2">
              <span className="text-[15px] font-bold text-gray-900 bg-white px-2 py-1 rounded shadow-sm border border-gray-100">12/20 {t(`θέσεις`, `spots`)}</span>
            </div>
          </div>
          ...
          <div className="p-4 bg-white grid grid-cols-1 md:grid-cols-3 gap-4">
             <div className="md:col-span-2 space-y-3">
               <h4 className="text-[15px] font-bold text-gray-800 tracking-wide flex items-center gap-2">
                 <Users className="w-4 h-4 text-gray-900" />{t(`Ομάδες`, `Groups`)}</h4>
               
               <div className="flex items-center justify-between p-3 bg-gray-50 rounded border border-gray-100">
                  <div>
                    <p className="text-[15px] font-bold text-gray-900">{t(`Ομάδα #1`, `Group #1`)} — 4/4</p>
                    <p className="text-[12.5px] text-gray-900 mt-0.5">{t(`Επιβεβαιωμένη`, `Confirmed`)}</p>
                  </div>
                  <div className="flex gap-2">
               ...
               <div className="flex items-center justify-between p-3 bg-gray-50 rounded border border-gray-100">
                  <div>
                    <p className="text-[15px] font-bold text-gray-900">{t(`Ομάδα #2`, `Group #2`)} — 3/4</p>
                    <p className="text-[12.5px] text-gray-900 mt-0.5">{t(`Αναμένεται 1 ακόμα`, `Waiting for 1 more`)}</p>
                  </div>
                  <div className="flex gap-2">
                    <button className="p-1.5 bg-white text-cyan-600 rounded shadow-sm border border-gray-200 hover:bg-cyan-50">
                      <MessageSquare className="w-3.5 h-3.5" />
             ...
             <div className="space-y-3">
               <h4 className="text-[15px] font-bold text-gray-800 tracking-wide flex items-center gap-2">
                 <Calendar className="w-4 h-4 text-gray-900" />{t(`Ενέργειες`, `Actions`)}</h4>
        ...
        <Card className="p-0 overflow-hidden border border-gray-200">
          <div className="p-4 flex flex-col md:flex-row items-start md:items-center justify-between gap-4 border-b border-gray-100 bg-gray-50/50">
            <div className="flex flex-col">
               <div className="flex items-center gap-2 mb-1">
                 ...
                 <span className="text-[12.5px] text-gray-900 font-bold tracking-wide">{t(`Σε 5 μέρες`, `In 5 days`)}</span>
               </div>
               <h3 className="text-[18px] font-bold text-[#111827]">{t(`Πεζοπορία στον Υμηττό`, `Hike on Hymettus`)}</h3>
            </div>
            <div className="flex gap-2">
              <span className="text-[15px] font-bold text-gray-900 bg-white px-2 py-1 rounded shadow-sm border border-gray-100">6/8 {t(`θέσεις`, `spots`)}</span>
            </div>
          </div>
          ...
          <div className="p-4 bg-white grid grid-cols-1 md:grid-cols-3 gap-4">
             ...
             <div className="space-y-3">
               <h4 className="text-[15px] font-bold text-gray-800 tracking-wide flex items-center gap-2">
                 <MoreHorizontal className="w-4 h-4 text-gray-900" />{t(`Περισσότερα`, `More`)}</h4>
               <Button variant="outline" className="w-full text-[15px]" size="sm">{t(`Επεξεργασία`, `Edit`)}</Button>
