  ...
  return (
    <div className="mx-auto max-w-full space-y-6 md:space-y-8">
      <div>
        ...
        <p className="mt-2 text-[16.2px] leading-relaxed text-gray-900 max-w-xl">{t(`Η αξιοπιστία σας βασίζεται στις επαληθεύσεις και τις αξιολογήσεις σας.`, `Your trust score is based on your verifications and reviews.`)}</p>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-2">
         <Card className="p-5 space-y-5">
           ...
           <div className="space-y-3">
             <div className="flex items-center justify-between">
               <div className="flex items-center gap-2 text-[13.5px] text-gray-900 font-medium">
                 <Mail className="h-3.5 w-3.5 text-gray-900" /> Email
               </div>
               <Badge variant="success" className="text-[11.2px] px-1.5 py-0.5">{t(`Επαληθευμένο`, `Verified`)}</Badge>
             </div>
             <div className="flex items-center justify-between">
               <div className="flex items-center gap-2 text-[13.5px] text-gray-900 font-medium">
                 <Phone className="h-3.5 w-3.5 text-gray-900" />{t(`Τηλέφωνο`, `Phone`)}</div>
               <Badge variant="success" className="text-[11.2px] px-1.5 py-0.5">{t(`Επαληθευμένο`, `Verified`)}</Badge>
             </div>
             <div className="flex items-center justify-between">
               <div className="flex items-center gap-2 text-[13.5px] text-gray-900 font-medium">
                 <CreditCard className="h-3.5 w-3.5 text-gray-900" />{t(`Πληρωμή`, `Payment`)}</div>
               <Badge variant="success" className="text-[11.2px] px-1.5 py-0.5">{t(`Επαληθευμένο`, `Verified`)}</Badge>
             </div>
             <div className="flex items-center justify-between">
               <div className="flex items-center gap-2 text-[13.5px] text-gray-900 font-medium">
                 <UserCheck className="h-3.5 w-3.5 text-gray-900" />{t(`Ταυτότητα`, `Government ID`)}</div>
           ...
           <div className="pt-4 border-t border-gray-100">
             ...
             <p className="text-[13.8px] text-gray-900 mt-1.5 font-medium leading-relaxed">{t(`Βασίζεται στις παρουσίες, αξιολογήσεις και συμπεριφορά σας.`, `Based on your attendance, reviews, and behavior.`)}</p>
           </div>
         </Card>
         ...
         <div className="space-y-3">
            ...
            <Card className="p-5 flex flex-col items-center">
              ...
              <p className="text-[12.5px] font-bold text-gray-900 tracking-wide">{t(`Βαθμός Αξιοπιστίας`, `Reliability Score`)}</p>
            </Card>
            ...
            <Card className="p-4 md:p-5 bg-gray-50 border-none shadow-none">
              ...
              <p className="text-[13.8px] md:text-[13.5px] text-gray-900 leading-relaxed">{t(`Κάθε επαλήθευση αυξάνει το επίπεδο εμπιστοσύνης σας, ξεκλειδώνοντας πρόσβαση σε εκδηλώσεις υψηλής ασφάλειας.`, `Each verification raises your trust tier, unlocking access to high-safety events.`)}</p>
            </Card>
            <Card className="p-4 md:p-5 bg-gray-50 border-none shadow-none">
              <h3 className="text-[12.1964473899675px] font-bold text-[#111827] tracking-wide mb-1.5">{t(`Επίπεδα Εμπιστοσύνης`, `Trust Tiers`)}</h3>
              <p className="text-[13.8px] md:text-[13.5px] text-gray-900 leading-relaxed">{t(`Newcomer → Verified → Trusted → Super Trusted. Κάθε επίπεδο απαιτεί περισσότερες επαληθεύσεις.`, `Newcomer → Verified → Trusted → Super Trusted. Each tier requires more verifications.`)}</p>
            </Card>
         </div>
      </div>
          ...
          {[
            ...
            <div key={i} className="flex gap-3">
              ...
              <div className="pb-4">
                ...
                <span className="text-[11.2px] text-gray-900 font-medium">{item.date}</span>
              </div>
            </div>
          ))}
        </div>
